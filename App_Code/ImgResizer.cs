...
namespace ImgResizerLib {
    public static class ImgResizer {
        ...
        public static void PerformImageResizeAndPutOnCanvas(string fname, string fname_thumb, int pWidth, int pHeight, string pOutputFileName) {

            Image imgBef;
            imgBef = Image.FromFile(fname);
